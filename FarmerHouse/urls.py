...
urlpatterns = [
    ...
    path('OutstandingReport/<str:name>',views.OutstandingReport,name="Outstanding Reports"),
    path('QuickPayment',views.QuickPayment,name="Quick Payment"),
    path('Details/<int:id>',views.QPDetails,name="Quick Payment Details"),
    ...
    path('QuickReceiptInvoiceNo',views.QuickReceiptInvoiceNo,name="Quick Receipt InvoiceNo"),
    path('DebitNote',views.DebitNote,name="Debit Note"),
    path('DebitNoteBill',views.DebitNoteBill,name="Debit Note Bill"),
    path('CreditNote',views.CreditNote,name="Credit Note"),
    path('CreditNoteInvoiceNo',views.CreditNoteInvoiceNo,name="Credit Note InvoiceNo"),
