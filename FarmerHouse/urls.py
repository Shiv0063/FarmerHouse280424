...
urlpatterns = [
    ...
    path('Stockswork/<int:id>/<str:type>',views.Stockswork,name='Stockswork'),
    ...
    path('PRStock/<int:id>/<int:id2>/<str:type>',views.PRStock,name='PRStock'),
    ...
    path('UserPurchaseEntry',views.UserPurchaseEntry,name="User Purchase Entry"),
    path('UserSalesReturnEntry',views.UserSalesReturnEntry,name="User Sales Return Entry"),
    path('UserPurchaseReturnEntry',views.UserPurchaseReturnEntry,name="User Purchase Return Entry"),
    path('UserLedgerReport',views.UserLedgerReport,name="User Ledger Report"),
    path('UserOutstandingReport',views.UserOutstandingReport,name="User Outstanding Report"),
    path('UserOutstandingReport/<str:name>',views.UserOutstandingReport,name="User Outstanding Reports"),
    path('ExpanseEntryReport',views.ExpanseEntryReport,name="Expanse Entry Report"),
    path('UserExpanseEntryReport',views.UserExpanseEntryReport,name="user Expanse Entry Report"),
    path('AllInvoice',views.AllInvoice,name="db Invoice"),
    path('CompletInvoice',views.CompletInvoice,name="db Complet Invoice"),
